...
router.get('/me/sms/status',    authenticate, authorize('landlord'), requiresStarter, controller.getMySmsStatus);
router.post('/me/sms/provision', authenticate, authorize('landlord'), requiresStarter, provisionSmsValidators, validate, controller.provisionMySms);
router.delete('/me/sms/provision', authenticate, authorize('landlord'), requiresStarter, controller.deprovisionMySms);
