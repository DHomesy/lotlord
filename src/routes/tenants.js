...
const { createTenantValidators, validate } = require('../middleware/validators');

router.get('/',      authenticate, authorize('admin', 'landlord'),                           controller.listTenants);
...
router.patch('/:id', authenticate, authorize('admin'),                                       controller.updateTenant);
