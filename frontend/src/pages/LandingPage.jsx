...
const FAQ = [
  ...
  },
  {
    ...
    a: '1 property · up to 4 units · tenant portal access · lease management · maintenance request tracking · document storage. Online rent collection and portfolio analytics require a paid plan.',
  },
  {
...
const PLANS = [
  {
    ...
    features: ['1 property · up to 4 units', 'Tenant portal access', 'Maintenance tracking', 'Lease & document storage', 'Email notifications'],
  ...
  },
  {
    ...
    price: '$19',
    period: '/ mo',
    description: 'Ideal for growing portfolios up to 5 properties.',
    features: ['Up to 5 properties · 25 units', 'Online rent collection', 'Basic portfolio analytics', 'Automated rent reminders', 'Late fee automation', 'Everything in Free'],
  ...
  },
  {
    ...
    price: '$49',
    period: '/ mo',
    description: 'For serious landlords managing a large portfolio.',
    features: ['Up to 20 properties · 100 units', 'Full dashboard analytics', 'Advanced reporting', 'Automated lease-expiry alerts', 'Priority email support', 'Everything in Starter'],
    cta: 'Get Started',
    ctaVariant: 'outlined',
    highlight: false,
    badge: null,
