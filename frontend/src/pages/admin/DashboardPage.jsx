            ...
            {!isEmployee && (
              <Box>
                <Typography variant="h6" fontWeight={600} mb={1}>
                  What you unlock with Paid ($10/mo)
                </Typography>
                ...
                <Grid container spacing={2}>
                  {[
                    ...
                    {
                      Icon: HomeWorkIcon,
                      title: 'Expanded Portfolio Limits',
                      desc: 'Free plan is limited to 2 properties with up to 4 units per property. Paid unlocks 5+ units and commercial access.',
                    },
                    {
                      Icon: GroupIcon,
                      title: 'All Core Features',
                      desc: 'Keep landlord and tenant workflows simple while scaling beyond small multi-family portfolios.',
                    },
                  ].map(({ Icon, title, desc }) => (
